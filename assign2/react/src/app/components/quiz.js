...
export class Quiz extends React.Component {
  constructor () {
    super()
    this.state = { coundtdown: 20, interval: null, response: {}, isQuizOver: false }
    this.timeUsed = 0
  ...
  componentWillMount () { this.fetchQuestion() }
  ...
  render () { return (this.state.isQuizOver ? this.quizOver() : this.quiz()) }
}
